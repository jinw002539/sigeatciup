...
<body class="pagina-com-menu">
    ...
    <main class="area-principal">
        ...
        <div class="barra-acoes revelar atraso-1">
            <select id="filtro-periodo" name="id_periodo" class="filtro-select" onchange="carregarTarefas()">
                ...
                <option value="5">1º Semestre (Jan–Jun)</option>
                <option value="6">2º Semestre (Jul–Dez)</option>
            </select>
        ...
        <div class="caixa-tarefa">
            ...
            <form id="form-tarefa" onsubmit="return false;">
                ...
                <div class="grupo-campo">
                    ...
                    <input type="text" id="tarefa-actividade" name="actividade" class="campo-entrada" placeholder="Descreva a actividade" required>
                </div>
                
                <div class="row g-3">
                    <div class="col-md-6 grupo-campo">
                        <label>Objectivos</label>
                        <textarea id="tarefa-objectivos" name="objectivos" class="campo-entrada" rows="3" placeholder="Quais os objectivos?"></textarea>
                    </div>
                    <div class="col-md-6 grupo-campo">
                        <label>Resultado Esperado</label>
                        <textarea id="tarefa-resultado" name="resultado_esperado" class="campo-entrada" rows="3" placeholder="O que se espera alcançar?"></textarea>
                    </div>
                </div>

                <div class="col-md-6 grupo-campo">
                    <label><i class="bi bi-calendar-event me-2"></i>Período de Execução</label>
                    <select id="tarefa-periodo" name="id_periodo" class="campo-entrada" required>
                ...
                <div class="grupo-campo">
                    ...
                    <select id="tarefa-dept" name="id_departamento" class="campo-entrada">
                ...
                <input type="hidden" name="estado" id="tarefa-estado" value="Aguardando">

                <div class="acoes-modal-tarefa">
                    <button type="button" class="botao-guardar" onclick="guardarTarefa()">
    ...
    <div id="fundo-atribuir" class="sobreposicao-tarefa">
        <div class="caixa-tarefa" style="max-width:420px;">
            ...
            <div class="grupo-campo mt-3">
                ...
                <select id="select-funcionario" class="campo-entrada">
                    <option value="">A carregar funcionários...</option>
                </select>
            </div>
